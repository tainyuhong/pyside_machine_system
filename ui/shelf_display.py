...
class Ui_shelf_display(object):
    def setupUi(self, shelf_display):
        ...
        self.gridLayout.addWidget(self.tb_up, 2, 0, 1, 7)
        ...
        self.gridLayout.addWidget(self.btn_export_up, 3, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_state_up, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.up_date, 1, 3, 1, 1)

        self.ckb_reupshelf = QCheckBox(self.tab_up)
        self.ckb_reupshelf.setObjectName(u"ckb_reupshelf")
        self.ckb_reupshelf.setFont(font1)

        self.gridLayout.addWidget(self.ckb_reupshelf, 1, 1, 1, 1)

        self.ckb_up = QCheckBox(self.tab_up)
        self.ckb_up.setObjectName(u"ckb_up")
        self.ckb_up.setFont(font1)

        self.gridLayout.addWidget(self.ckb_up, 1, 2, 1, 1)

        self.bt_up_select = QPushButton(self.tab_up)
        self.bt_up_select.setObjectName(u"bt_up_select")
        self.bt_up_select.setFont(font1)

        self.gridLayout.addWidget(self.bt_up_select, 1, 6, 1, 1)

        self.end_up_time = QDateEdit(self.tab_up)
        self.end_up_time.setObjectName(u"end_up_time")
        self.end_up_time.setEnabled(False)
        self.end_up_time.setFont(font1)
        self.end_up_time.setCalendarPopup(True)

        self.gridLayout.addWidget(self.end_up_time, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_export_down, 3, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tb_down, 2, 0, 1, 6)
        ...
        self.gridLayout_2.addWidget(self.bt_hand_over, 3, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bt_down_select, 1, 5, 1, 1)

        self.end_down_time = QDateEdit(self.tab_down)
        self.end_down_time.setObjectName(u"end_down_time")
        self.end_down_time.setEnabled(False)
        self.end_down_time.setFont(font1)
        self.end_down_time.setCalendarPopup(True)

        self.gridLayout_2.addWidget(self.end_down_time, 1, 3, 1, 1)
    ...
    def retranslateUi(self, shelf_display):
        ...
        self.ckb_reupshelf.setText(QCoreApplication.translate("shelf_display", u"\u91cd\u65b0\u4e0a\u67b6", None))
