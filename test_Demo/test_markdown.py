...
from PySide6.QtWidgets import *   #(QAction, QApplication, QListWidget,QMainWindow, QSplitter, QTextBrowser)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.groupsList = QListWidget()         # 组列表
        self.messagesList = QListWidget()       # 消息列表
        self.messageView = QTextBrowser()       # 内容
        ...
        self.mainSplitter.setStretchFactor(0, 1)        # 设置第一列占比
        self.mainSplitter.setStretchFactor(1, 3)        # 设置第二列占比
        self.messageSplitter.setStretchFactor(0, 1)     # 设置第一行占比
        self.messageSplitter.setStretchFactor(1, 2)     # 设置第三行占比
