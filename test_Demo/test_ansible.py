...
from ansible.inventory.manager import InventoryManager      # 用于创建主机清单，主机清单的源采用配置文件或是逗号分开主机名字符串
from ansible.parsing.dataloader import DataLoader       # 用来加载解析yaml文件或JSON内容,并且支持vault的解密
from ansible.playbook.play import Play
from ansible.plugins.callback import CallbackBase
from ansible.vars.manager import VariableManager        # 管理变量的类，包括主机，组，扩展等变量
...
def main():
    host_list = ['192.168.1.70', '192.168.1.61', 'www.baidu.com']
